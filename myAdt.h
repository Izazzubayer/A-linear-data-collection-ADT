 ...
 */
    ...
    Profile * elements[MAX_ALPHA];                  // MAX_ALPHA arrays of elements created in the heap
 ...
 */
    ...
    // Description: Returns the index of the array of elements where the element is found, otherwise returns -1.
    int findIndex(const char searchKey) const;
